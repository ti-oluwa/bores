...
def _(avg_pressure_history, bores, np):
    ...
    pressure_fig = bores.make_series_plot(
        ...
        title="Pressure Analysis (CASE 3)",
        x_label="Time Step",
...
@app.cell
def _(bores, np, solvent_concentration_history):
    # Dissolved gas (Solvent) Conc.
    solvent_conc_fig = bores.make_series_plot(
        data={
            "Avg. Dissolved Gas Concentration": np.array(solvent_concentration_history),
        },
        title="Solvent Concentration Analysis (CASE 3)",
        x_label="Time Step",
...
def _(
    ...
    capillary_pressure_fig = bores.make_series_plot(
        ...
        title="Capillary Pressure Analysis (CASE 3)",
        x_label="Time Step",
...
def _(analyst, bores, np):
    ...
    oil_production_fig = bores.make_series_plot(
        ...
        title="Oil Production Analysis (CASE 3)",
        x_label="Time Step",
...
def _(analyst, bores, np):
    ...
    water_production_fig = bores.make_series_plot(
        ...
        title="Water Production Analysis (CASE 3)",
        x_label="Time Step",
        y_label="Production (STB)",
        marker_sizes=6,
        width=720,
...
def _(analyst, bores, np):
    ...
    gas_production_fig = bores.make_series_plot(
        ...
        title="Gas Production Analysis (CASE 3)",
        x_label="Time Step",
...
def _(analyst, bores, np):
    ...
    gas_injection_fig = bores.make_series_plot(
        ...
        title="Gas Injection Analysis (CASE 3)",
        x_label="Time Step",
...
def _(analyst, bores, np):
    ...
    cumulative_oil_production_fig = bores.make_series_plot(
        ...
        title="Cumulative Oil Production Analysis (CASE 3)",
        x_label="Time Step",
        y_label="Production (STB)",
        marker_sizes=6,
        width=720,
...
def _(analyst, bores, np):
    ...
    cumulative_water_production_fig = bores.make_series_plot(
        ...
        title="Cumulative Water Production Analysis (CASE 3)",
        x_label="Time Step",
        y_label="Production (STB)",
        marker_sizes=6,
        width=720,
...
def _(analyst, bores, np):
    ...
    cumulative_gas_production_fig = bores.make_series_plot(
        ...
        title="Cumulative Gas Production Analysis (CASE 3)",
        x_label="Time Step",
        y_label="Production (SCF)",
        marker_sizes=6,
        width=720,
...
def _(bores, gor_history, np, water_cut_history):
    ...
    fluid_cut_plots = bores.merge_plots(
        water_cut_fig, gor_fig, cols=2, title="Fluid Cut Analysis (CASE 3)"
    )
...
def _(analyst, bores, np):
    ...
    cumulative_gas_injection_fig = bores.make_series_plot(
        ...
        title="Cumulative Gas Injection Analysis (CASE 3)",
        x_label="Time Step",
        y_label="Injection (SCF)",
        marker_sizes=6,
        width=720,
...
def _(analyst, bores, np):
    ...
    reserves_plots = bores.merge_plots(
        ...
        gas_reserve_fig,
        cols=2,
        title="Reserves Analysis (CASE 3)",
    )
    reserves_plots.show()
    return
...
def _(
    ...
    sweep_efficiency_plots = bores.merge_plots(
        ...
        cols=2,
        title="Sweep Efficiency Analysis (CASE 3)",
    )
...
def _(analyst, bores, np):
    ...
    displacement_ratio_plots = bores.merge_plots(
        vrr_fig,
        mobility_ratio_fig,
        cols=2,
        title="Displacement Ratios Analysis (CASE 3)",
    )
...
def _(analyst, bores, np, recovery_efficiency_history):
    ...
    recovery_plots = bores.merge_plots(
        ...
        recovery_factor_fig,
        cols=2,
        title="Recovery Analysis (CASE 3)",
    )
    recovery_plots.show()
    return
...
def _(analyst, bores, np):
    ...
    if error := decline_curve.error:
        ...
        production_forecast_fig = bores.make_series_plot(
            ...
            title="Production Forecast (CASE 3)",
            x_label="Time Step",
